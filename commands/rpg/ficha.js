      ...
      if (i === 0)
        embeds.push(
          new EmbedBuilder()
            ...
            .addFields(
              {
                name: `***${ficha.base_stats}***`,
                value: `*${st.pc}s:* ***${user.PC}***`,
              },
              {
                name: "\u200B",
                value: `💪 ${st.for}: \n 🤸 ${st.agi}: \n 🧱 ${st.res}: \n 🧠 ${st.int}: \n 😎 ${st.car}: \n ✨ ${st.ess}: \n 🌀 ${st.sin}:`,
        ...
        embeds.push(
          new EmbedBuilder()
            ...
            .addFields(
              {
                name: `***${ficha.inventory}***`,
                value: `*${ficha.wg}:* ***???***`,
                inline: true,
              }, //Botar peso total aqui
