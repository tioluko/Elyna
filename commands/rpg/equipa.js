...
module.exports = {
    ...
    async autocomplete(interaction) {
        ...
        //if (user.EVENT.startsWith('combate:')) return interaction.respond(blockAutocomplete(eq.on_event));
        //if (user.EVENT.startsWith('rest:')) return interaction.respond(blockAutocomplete(eq.on_rest));
